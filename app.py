...
# ── 自己PRテンプレート ──────────────────────────────────
PR_TEMPLATES = {
    "事務職向け": "前職では〇〇業務を担当し、正確かつ迅速な処理を心がけてきました。データ入力や書類管理では、ミスをなくすためにダブルチェックを徹底し、チーム全体の業務効率化に貢献しました。コミュニケーションを大切にし、関係部署と連携しながら業務を進めることが得意です。貴社でもこれまでの経験を活かし、縁の下の力持ちとして貢献したいと考えております。",
    "営業職向け": "前職では〇〇の営業職として、新規開拓から既存顧客のフォローまで幅広く担当してきました。お客様のニーズをしっかりとヒアリングし、最適な提案を行うことで信頼関係を築くことを意識してきました。目標達成に向けて粘り強く取り組む姿勢と、チームワークを大切にする点が強みです。貴社でも営業力を活かし、売上拡大に貢献したいと考えております。",
    "エンジニア向け": "これまで〇〇の開発業務に携わり、要件定義から設計・実装・テストまでの一連の工程を経験してきました。チームでの開発を通じて、コミュニケーションの重要性を学び、技術力だけでなく、わかりやすいドキュメント作成や課題共有にも力を入れてきました。新しい技術への学習意欲が高く、常に自己研鑽を続けています。貴社でも即戦力として貢献できると考えております。",
    "販売・接客向け": "前職では〇〇の販売・接客業務に従事し、お客様に喜んでいただくことを第一に考えてきました。笑顔と丁寧な対応を心がけ、リピーターのお客様からお声がけいただくことも多くありました。繁忙期でも冷静に対応できるメンタルと、チームで助け合う姿勢が強みです。貴社でも接客の経験を活かし、お客様満足度の向上に努めたいと思います。",
